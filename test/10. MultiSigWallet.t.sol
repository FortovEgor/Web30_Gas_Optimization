...
contract MultiSigWalletOptimizedTest is Test {
    ...
    function testSubmitTransaction() public {  // 3000 gas optimization
        vm.startPrank(owner1);
        wallet.submitTransaction(address(0x4), 100);
        assertEq(wallet.getTransactionCount(), 1);
    ...
    function testExecuteTransaction() public {  // 4000 gas optimization
        vm.startPrank(owner1);
        wallet.submitTransaction(address(0x4), 100);
    ...
    function testExecutionFailure() public {  // 4000 gas optimization
        vm.startPrank(owner1);
        wallet.submitTransaction(address(0x4), 100 ether);
    ...
    function testOnlyOwnerCanSubmit() public {  // 7000 gas optimization
        vm.prank(address(0x5));
        vm.expectRevert("Not owner");
        wallet.submitTransaction(address(0x4), 100);
    }

    function testOnlyOwnerCanConfirm() public {  // 6000 gas optimization
        vm.prank(owner1);
        wallet.submitTransaction(address(0x4), 100);
    ...
    function testOnlyOwnerCanExecute() public {  // 6000 gas optimization
        vm.startPrank(owner1);
        wallet.submitTransaction(address(0x4), 100);
